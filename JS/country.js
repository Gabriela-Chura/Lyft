...
var lista = $("#lista-paises");
	...
	for (var i=0; i < leng; i++){
		...
		var html = '<a id="country" href="singup.html"><li class="list-group-item">'+'<img class="flag" src="'+ paises[i].imageURL+'" style="height:20px; width: 30px;" alt=""><p class="country" style="margin-left:5px;">'+paises[i].nombre+'</p><span class="codigo" style="display:none;">+'+paises[i].phone_code+'</span>'+'</li></a>'; 
    ...
    var srclocal=$(this, '.flag')[0].src;
	var codelocal=$(this, '.codigo')[0].textContent;
